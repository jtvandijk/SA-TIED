...
The Pearson correlation coefficient suggests a moderate negative association between the proportion of people without schooling an the average age at the municipal level. 
...
4. Join all the data together and then:
    ...
    * Calculate the geographically weighted *correlation* between the two variables, again selecting the optimal bandwidth using an automatic selector.
