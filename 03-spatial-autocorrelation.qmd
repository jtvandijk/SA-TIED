...
#| filename: "R code"
# local moran's test
lmoran <- localmoran_perm(sa_municipality$mn_prop_no_schooling, listw = sa_mn_nb_weights, nsim = 999)
...
1. Extract the centroids from the `sa_municipality` file.
...
## Solutions [Optional]
There are several ways to achieve the above, but if you would like to see an example solution, you can find it here: [[Link]](https://github.com/jtvandijk/SA-TIED/blob/master/solutions/s03-assignment.R)
