...
| File                                 | Type   | Link |
| :------                              | :------| :------ |
| SA Census 2011 Language Table        | `.dta` | [Download](https://github.com/jtvandijk/SA-TIED/tree/master/data/attributes/language.dta) |
...
### Loading data
Next, we can load the `language.dta` file into R. Using the `haven` library, R is capable to read a large range of different filetypes. This includes Stata `.dta` files:
...
| File                                 | Type   | Link |
| :------                              | :------| :------ |
| SA Census 2011 Internet Access Table          | `.dta` | [Download](https://github.com/jtvandijk/SA-TIED/tree/master/data/attributes/internet-access.dta) |
