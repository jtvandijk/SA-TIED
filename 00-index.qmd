...
While there are no specific prerequisites for this workshop, basic familiarity with [R](https://www.r-project.org/), [Python](https://www.python.org/downloads/) or   [Stata](https://www.stata.com/) **do-files** .
